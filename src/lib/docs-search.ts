...
const DOC_INDEX: DocIndexEntry[] = [
  ...
  // ── SAP ABAP / Coding ────────────────────────────────────────
  { id: 'sap-abap', title: 'SAP ABAP Cloud Development', section: 'ABAP & Coding', module: 'sap', moduleName: 'SAP S/4HANA', href: '/docs/sap', keywords: ['abap','btp','rap','cds','odata','key user','custom logic','extensibility','steampunk','badi','custom field','abap cloud','clean core'], text: 'abap btp rap cds odata key user custom logic extensibility steampunk badi custom field abap cloud clean core tier' },
  { id: 'sap-key-user', title: 'SAP Key User Extensibility', section: 'Custom Fields & Logic', module: 'sap', moduleName: 'SAP S/4HANA', href: '/docs/sap', keywords: ['key user','custom field','custom logic','badi','no code','extension','transport','custom form'], text: 'key user extensibility custom field logic badi transport custom form no code adaptation' },

  // ── Hardware Additions ───────────────────────────────────────
  { id: 'hw-firewall', title: 'Firewall Configuration', section: 'Firewall Rules & Troubleshooting', module: 'hardware', moduleName: 'Hardware & Network', href: '/docs/hardware', keywords: ['firewall','netsh','windows firewall','block','allow','rule','port','fortinet','cisco asa','pfsense','dmz','nat','deny'], text: 'firewall netsh windows firewall rule allow block port fortinet cisco asa pfsense dmz nat pat stateful ngfw' },
  { id: 'hw-server', title: 'Physical Server Setup', section: 'Server Hardware & Maintenance', module: 'hardware', moduleName: 'Hardware & Network', href: '/docs/hardware', keywords: ['server','dell','hp proliant','idrac','ilo','raid','poweredge','firmware','bios server','physical server','rack server'], text: 'physical server dell poweredge hp proliant idrac ilo raid firmware setup maintenance hardware health' },
  { id: 'hw-infra', title: 'IT Infrastructure & Data Center', section: 'Infrastructure & Cabling', module: 'hardware', moduleName: 'Hardware & Network', href: '/docs/hardware', keywords: ['infrastructure','data center','rack','cabling','ups','structured cabling','hot aisle','cold aisle','pdu','server room','tia-568'], text: 'it infrastructure data center rack cabling ups structured cabling hot cold aisle pdu server room tia-568 fiber' },
  { id: 'hw-ap', title: 'Wireless Access Points', section: 'WiFi Infrastructure & APs', module: 'hardware', moduleName: 'Hardware & Network', href: '/docs/hardware', keywords: ['access point','ap','ubiquiti','unifi','meraki','ssid','wpa3','802.11','wifi 6','channel','enterprise wifi','roaming','captive portal'], text: 'access point ubiquiti unifi cisco meraki ssid wpa3 802.11ax wifi6 channel band steering roaming captive portal' },

  // ── IT Recap ──────────────────────────────────────────────────
  { id: 'recap-networking', title: 'Networking Fundamentals', section: 'OSI Model & TCP/IP', module: 'itrecap', moduleName: 'IT Recap', href: '/docs/itrecap', keywords: ['osi','tcp/ip','networking','subnet','cidr','protocol','http','dns','dhcp','ip address','layer','packet','routing'], text: 'osi model tcp/ip networking subnet cidr protocol http dns dhcp ip address layer packet routing subnetting' },
  { id: 'recap-ad', title: 'Active Directory', section: 'AD & LDAP', module: 'itrecap', moduleName: 'IT Recap', href: '/docs/itrecap', keywords: ['active directory','ad','ldap','domain','gpo','fsmo','user','group','ou','forest','powershell','domain controller'], text: 'active directory ad ldap domain gpo fsmo user group ou forest domain controller powershell get-aduser' },
  { id: 'recap-security', title: 'Security Fundamentals', section: 'Cybersecurity Basics', module: 'itrecap', moduleName: 'IT Recap', href: '/docs/itrecap', keywords: ['security','cia triad','encryption','mfa','phishing','ransomware','firewall','zero trust','vulnerability','patch','penetration test'], text: 'security cia triad encryption mfa phishing ransomware firewall zero trust vulnerability patch pen test aes tls' },
  { id: 'recap-cloud', title: 'Cloud Computing Fundamentals', section: 'IaaS PaaS SaaS', module: 'itrecap', moduleName: 'IT Recap', href: '/docs/itrecap', keywords: ['cloud','iaas','paas','saas','azure','aws','public cloud','private cloud','hybrid','elasticity','scalability'], text: 'cloud iaas paas saas azure aws public private hybrid cloud elasticity scalability auto-scaling shared responsibility' },
  { id: 'recap-itil', title: 'ITIL & Service Management', section: 'ITIL Practices', module: 'itrecap', moduleName: 'IT Recap', href: '/docs/itrecap', keywords: ['itil','incident','problem','change','service desk','sla','mttr','rto','rpo','priority','p1','p2','change management'], text: 'itil incident problem change service desk sla mttr rto rpo priority p1 p2 change management itsm' },
  { id: 'recap-virt', title: 'Virtualization', section: 'VMware & Hyper-V', module: 'itrecap', moduleName: 'IT Recap', href: '/docs/itrecap', keywords: ['vmware','hyperv','hyper-v','esxi','vsphere','virtual machine','container','docker','proxmox','vmotion','ha'], text: 'vmware hyper-v esxi vsphere vcenter virtual machine container proxmox vmotion ha drs snapshot' },
  { id: 'recap-powershell', title: 'PowerShell Quick Reference', section: 'PowerShell Commands', module: 'itrecap', moduleName: 'IT Recap', href: '/docs/itrecap', keywords: ['powershell','cmdlet','script','get-service','invoke-command','pssession','remoting','pipeline','variable','foreach'], text: 'powershell cmdlet script get-service start-service invoke-command pssession remoting pipeline variable foreach function' },
  { id: 'recap-backup', title: 'Backup & Disaster Recovery', section: 'Backup & DR', module: 'itrecap', moduleName: 'IT Recap', href: '/docs/itrecap', keywords: ['backup','disaster recovery','dr','rpo','rto','3-2-1','incremental','full backup','snapshot','veeam','restore'], text: 'backup disaster recovery dr rpo rto 3-2-1 rule incremental full differential snapshot veeam acronis restore' },
  { id: 'recap-winserver', title: 'Windows Server Roles', section: 'Windows Server', module: 'itrecap', moduleName: 'IT Recap', href: '/docs/itrecap', keywords: ['windows server','ad ds','dhcp server','dns server','hyper-v','file server','iis','wsus','rds','event id'], text: 'windows server ad ds dhcp dns hyper-v file server iis wsus rds event id roles features powershell' },
