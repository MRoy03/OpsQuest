...
import {
  ...
  Trophy, FileText, ChevronRight, Shield, Settings,
} from 'lucide-react'
    ...
    <aside className="w-64 shrink-0 flex flex-col h-screen sticky top-0 border-r border-[#1a2f4a] bg-[#0a1525]">
      ...
      <div className="px-6 py-5 border-b border-[#1a2f4a]">
        <div className="flex items-center gap-3">
          <div className="relative w-9 h-9 rounded-lg bg-[#00d4ff11] border border-[#00d4ff33] flex items-center justify-center">
      ...
      {/* User badge */}
      <div className="px-4 py-4 border-t border-[#1a2f4a]">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-[#ffffff05]">
          <div className="w-8 h-8 rounded-full bg-[#7c3aed22] border border-[#7c3aed44] flex items-center justify-center text-sm">
            🔧
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-[#e2e8f0] truncate">Alex Reeves</p>
            <p className="text-[10px] text-[#7c3aed]">IT Engineer · Lv5</p>
          </div>
          <Settings className="w-3.5 h-3.5 text-[#475569] hover:text-[#94a3b8] cursor-pointer" />
        </div>
      </div>
    </aside>
  )
